package example.fussen.watch.device;
...
import example.fussen.watch.reciver.UninstallReciver;
...
public class DeviceMethod {
    ...
    private DeviceMethod (Context context){
        ...
        componentName=new ComponentName(context, UninstallReciver.class);
    }
    ...
    public void onActivate() {
        ...
        if (!devicePolicyManager.isAdminActive(componentName)) {
            ...
            intent.putExtra(DevicePolicyManager.EXTRA_DEVICE_ADMIN,
                    componentName);
            intent.putExtra(DevicePolicyManager.EXTRA_ADD_EXPLANATION, "你最好想一下，再激活哦，哥哥可不骗你，这是余福升说的");
